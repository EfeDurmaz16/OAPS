...
- draft: protocol-positioning, ecosystem, and review packet docs that are expected to evolve
- concept: future review targets or narrative expansions that are not yet claimed as implemented

Suggested reading order:

1. `../CHARTER.md`
2. `MATURITY-MATRIX.md`
3. `HOW-TO-REVIEW-OAPS.md`
4. `SUITE-ARCHITECTURE.md`
5. `STANDARDS-LANDSCAPE.md`
6. `PROTOCOL-POSITIONING.md`
7. `ECOSYSTEM-MAP.md`
8. `REVIEW-TARGET-MATRIX.md`
9. `REVIEW-PACKET-INDEX.md`
10. `REVIEW-CALENDAR.md`
