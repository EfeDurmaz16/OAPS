...
Bindings describe how AICP semantics travel over concrete transport surfaces.
...
| JSON-RPC | [`spec/bindings/jsonrpc-binding-draft.md`](../spec/bindings/jsonrpc-binding-draft.md) | Draft | request/response RPC mapping above AICP semantics |
