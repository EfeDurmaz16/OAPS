...
| gRPC and event/webhook binding families | Concept | These are still architecture-track only and do not yet have draft specs or conformance packs. | `docs/SUITE-ARCHITECTURE.md`, `ROADMAP.md` |
