...
| event/webhook binding family | Concept | This remains architecture-track only and does not yet have a draft spec or conformance pack. | `docs/SUITE-ARCHITECTURE.md`, `ROADMAP.md` |
